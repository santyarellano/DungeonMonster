...
public class Poison extends GameObj {
	...
	public Poison(int xPos, int yPos, int width, int height) {
		...
		frameChange = 5;
		// Get images
		File fSprIdle = new File("res/Images/FX/poison/idle.png");
		File fSprStp1 = new File("res/Images/FX/poison/1.png");
		File fSprStp2 = new File("res/Images/FX/poison/2.png");
		File fSprStp3 = new File("res/Images/FX/poison/3.png");
		File fSprStp4 = new File("res/Images/FX/poison/4.png");
		File fSprStp5 = new File("res/Images/FX/poison/5.png");
		File fSprStp6 = new File("res/Images/FX/poison/6.png");
		File fSprStp7 = new File("res/Images/FX/poison/7.png");
		File fSprStp8 = new File("res/Images/FX/poison/8.png");
		File fSprStp9 = new File("res/Images/FX/poison/9.png");
		File fSprStp10 = new File("res/Images/FX/poison/10.png");
		File fSprStp11 = new File("res/Images/FX/poison/11.png");
		File fSprStp12 = new File("res/Images/FX/poison/12.png");
		File fSprStp13 = new File("res/Images/FX/poison/13.png");
		File fSprStp14 = new File("res/Images/FX/poison/14.png");
		File fSprStp15 = new File("res/Images/FX/poison/15.png");
		File fSprStp16 = new File("res/Images/FX/poison/16.png");
		File fSprStp17 = new File("res/Images/FX/poison/17.png");
		try {
